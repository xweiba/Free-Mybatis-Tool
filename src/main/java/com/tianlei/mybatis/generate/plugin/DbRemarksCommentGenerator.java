...
public class DbRemarksCommentGenerator
...
//        this.isAnnotations = StringUtility.isTrue(properties.getProperty("annotations"));
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
        if (this.columnRemarks &&
                StringUtility.stringHasValue(introspectedColumn.getRemarks())) {
        ...
        /*if (this.isAnnotations) {
            ...
            if (introspectedColumn.isIdentity()) {
                if (isId) field.getAnnotations().remove("@GeneratedValue");
